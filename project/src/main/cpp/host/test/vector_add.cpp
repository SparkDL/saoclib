...
int main(int argc, char **argv) {
    ...
    ArgBufferFloat A_data = ArgBufferFloat(a->get(), N, KernelArgMode::mode_input);
    ArgBufferFloat B_data = ArgBufferFloat(b->get(), N, KernelArgMode::mode_input);
    ArgBufferFloat C_data = ArgBufferFloat(c->get(), N, KernelArgMode::mode_output);
