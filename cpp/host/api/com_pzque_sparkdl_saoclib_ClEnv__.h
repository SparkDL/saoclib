...
#include <jni.h>
/* Header for class com_pzque_sparkdl_saoclib_ClEnv__ */

#ifndef _Included_com_pzque_sparkdl_saoclib_ClEnv__
#define _Included_com_pzque_sparkdl_saoclib_ClEnv__
#ifdef __cplusplus
extern "C" {
#endif
/*
